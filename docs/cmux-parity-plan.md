...
- Browser command bridge parity beyond the current slices: native browser cookie database extraction/decryption, history/session import, full accessibility-tree parity, richer live smokes, and full cross-frame/platform refs.
