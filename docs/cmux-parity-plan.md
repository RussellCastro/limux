...
- Browser command bridge parity beyond the current slices: WebKitGTK profile-level cookie/session import, full accessibility-tree parity, richer live smokes, and full frame-stable refs.
