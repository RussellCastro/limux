...
- Browser command bridge parity beyond the current slices: consent-gated profile-data import design before any native browser cookie database extraction/decryption, history/session import, full accessibility-tree parity, storage/cookie edge smokes, and full cross-frame/platform refs.
