...
- Browser command bridge parity beyond the current slices: native browser profile discovery, history/session import, full accessibility-tree parity, richer live smokes, and full frame-stable refs.
