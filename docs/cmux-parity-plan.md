...
- Browser command bridge parity beyond the first live slice: screenshots, browser profile import, full accessibility-tree parity, and full frame-stable refs.
