...
navigate, URL lookup, title lookup, and basic JS eval; broader browser
automation remains separate work. Check `docs/cmux-parity-plan.md` before
changing agent or browser automation.
